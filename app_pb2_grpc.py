...
class AgntServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Connect = channel.stream_stream(
                '/agnt.AgntService/Connect',
                request_serializer=app__pb2.AgentMessage.SerializeToString,
                response_deserializer=app__pb2.ServerMessage.FromString,
                _registered_method=True)


class AgntServiceServicer(object):
    """Bidirectional streaming service
    """
...
def add_AgntServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Connect': grpc.stream_stream_rpc_method_handler(
                    servicer.Connect,
                    request_deserializer=app__pb2.AgentMessage.FromString,
                    response_serializer=app__pb2.ServerMessage.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'agnt.AgntService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('agnt.AgntService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class AgntService(object):
    """Bidirectional streaming service
    """
    ...
    def Connect(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/agnt.AgntService/Connect',
            app__pb2.AgentMessage.SerializeToString,
            app__pb2.ServerMessage.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
